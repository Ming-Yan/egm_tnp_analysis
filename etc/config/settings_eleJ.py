...
baseOutDir = 'results/HZgID_94X_trg1_L1_test/'
...
samplesDef = {
    'data'   : tnpSamples.HZg_L1match['data_2017'].clone(),
    'mcNom'  : tnpSamples.HZg_L1match['DY_LO'].clone(),
    'mcAlt'  : tnpSamples.HZg_L1match['DY_NLO'].clone(),
    'tagSel' : tnpSamples.HZg_L1match['DY_LO'].clone(),
}
...
cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.5 && el_q*tag_Ele_q < 0&& (el_dxy<1.0&&el_dz<0.5&&passingMVA94Xwp90isoV2==1)'#17 // James
...
tnpParNomFit = [
    ...
    "acmsP[60,0,120]","betaP[0.,0.08] ","gammaP[0.146]","peakP[90.0]",
    "acmsF[60.,30.,120.]","betaF[0.05,0.001, 0.08]","gammaF[0.1]","peakF[90.0]",
    ]
tnpParAltSigFit = [
...
#tnpParAltSigFit = [
#    "meanP[-0.0,-100.0,100.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
#    "meanF[-0.0,-100.0,100.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
