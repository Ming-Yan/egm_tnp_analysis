...
baseOutDir = 'results/2017HLT_leg1/'
#############################################################
...
tnpParNomFit = [
    ...
    "meanF[-0.0,-5.0,5.0]","sigmaF[0.9,0.5,4.0]",
    "acmsP[60.,50.,120.]","betaP[0.05,0.01,0.1]","gammaP[0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,50.,120.]","betaF[0.05,0.01,0.1]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]
