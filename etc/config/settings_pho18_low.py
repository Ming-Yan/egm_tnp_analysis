...
baseOutDir = 'results/HZgphoID18_nocorr90_low/'
...
tnpParNomFit = [
    ...
    "acmsF[60.,30.,80.]","betaF[0.05,0.001,0.1]","gammaF[0.1, -2, 2]","peakF[90.0]",
    ]

tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,7]',"sigmaP_2[1.5,0.5,6.0]","sosP[0.001,7.0]",
    "meanF[-2,-10,0.]","sigmaF[2,1.0,12.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,7]',"sigmaF_2[2.0,0.8,6.0]","sosF[1,0.001,6.0]",
    "acmsP[60.,40.,80.]","betaP[0.04,0.01,0.08]","gammaP[0.1, -1.5, 1]","peakP[90.0]",
    "acmsF[60.,50.,70.]","betaF[0.1,0.02,0.1]","gammaF[0.1, 0., 1]","peakF[90.0]",
    #"acmsF[40.,25.,80.]","betaF[0.04,0.001,0.08]","gammaF[-0.008]","peakF[90.0]",                                 
    ]
...
#    "p0F[0.6, -5., 10.]", "p1F[-0.25, -5., 1.5]", "p2F[0.1, -1., 2.5]",
    ]
