...
baseOutDir = 'results/2018_runA_low'
...
biningDef = [
   ...
   { 'var' : 'sc_abseta' , 'type': 'float', 'bins': [0.0,1.0,1.4442,1.566,2.0,2.5]},
   #   { 'var' : 'sc_eta' , 'type': 'float', 'bins': [-2.5,-1.479, 0.0, 1.479, 2.5] },
   { 'var' : 'sc_et' , 'type': 'float', 'bins': [10.0,20.0] },
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 1.4442 && abs(sc_eta)<2.5 && tag_Ele_trigMVA > 0.96 && sqrt( 2*event_met_pfmet*tag_Ele_pt*(1-cos(event_met_pfphi-tag_Ele_phi))) < 45 && sc_et > 10'
