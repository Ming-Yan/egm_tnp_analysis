...
biningDef = [
   ...
   { 'var' : 'sc_et' , 'type': 'float', 'bins': [20.0,45,75] },
...
tnpParNomFit = [
   ...
   "meanF[0.005,-8.0,8.0]","sigmaF[1.2,1.5,5.0]",
   "acmsP[80,50.,100.]","betaP[0.057,0.001,0.8]","gammaP[0.05, 0.001, 1]","peakP[90.0]",
   "acmsF[60,40.,70.]","betaF[0.01,0.005,0.5]","gammaF[0.04, 0.001, 0.5]","peakF[90.0]",
]
