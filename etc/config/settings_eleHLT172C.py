...
baseOutDir = 'results/HZgID_94X_trg2_wpL_C/'
...
samplesDef = {
    'data'   : tnpSamples.HZg_L1match['data_94X_C'].clone(),
...
#cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.5 && el_q*tag_Ele_q < 0&& (el_dxy<1.0&&el_dz<0.5&&passingMVA94Xwp90isoV2==1)'
cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.5 && el_q*tag_Ele_q < 0&& (el_dxy<1.0&&el_dz<0.5&&passingMVA94XwpLisoV2==1)'#17
#cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.5 && el_q*tag_Ele_q < 0&& (passingMVA94XwpHZZisoV2 == 1)&&el_dxy<1.0&&el_dz<0.5&&el_sip<4'#17
