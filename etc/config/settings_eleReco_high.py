...
baseOutDir = 'results/2018_runA_high'
...
#    ]
tnpParNomFit = [ 
   "meanP[-0.0,-5.0,5.0]","sigmaP[1.5,5.0]",
   "meanF[-0.0,-10.0,10.0]","sigmaF[1.5,1.2,8.0]",
   "acmsP[120.,40.,180.]","betaP[0.1,0.001,.1]","gammaP[0.1, 0, 1]","peakP[80,90.0]",
   "acmsF[120,50.,150.]","betaF[0.01,0.001,0.1]","gammaF[0.1, 0.001, 1]","peakF[80.0,90.0]",
   ]
